      ...
      <div class="row" data-aos="fade-up">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card feature-card h-100">
            ...
            <div class="card-body">
              <h5 class="card-title font-strong"> Choosing the right Person  </h5>
              <p class="card-text text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit Consectetur quisquam magni eaque odit.  </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card feature-card h-100">
            <img class="card-img-top" src="<?php echo get_stylesheet_directory_uri(); ?>/img/default.jpg" alt="">
            <div class="card-body">
              <h5 class="card-title font-strong"> Retention of Original State  </h5>
              <p class="card-text text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit Consectetur quisquam magni eaque odit.  </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card feature-card h-100">
            <img class="card-img-top" src="<?php echo get_stylesheet_directory_uri(); ?>/img/default.jpg" alt="">
            <div class="card-body">
              <h5 class="card-title font-strong"> Updation and Reporting of Tasks  </h5>
              <p class="card-text text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit Consectetur quisquam magni eaque odit.  </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card feature-card h-100">
            <img class="card-img-top" src="<?php echo get_stylesheet_directory_uri(); ?>/img/default.jpg" alt="">
            <div class="card-body">
              <h5 class="card-title font-strong"> Support Queries of Clients </h5>
              <p class="card-text text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit Consectetur quisquam magni eaque odit.  </p>
            </div>
          </div>
        </div>
